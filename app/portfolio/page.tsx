...
import TestimonialImg01 from "@/public/images/testimonial-10.jpg";
import TestimonialImg02 from "@/public/images/testimonial-11.jpg";
import TestimonialImg03 from "@/public/images/testimonial-12.jpg";
import TestimonialImg04 from "@/public/images/testimonial-13.jpg";
import TestimonialImg05 from "@/public/images/testimonial-14.jpg";
import TestimonialImg06 from "@/public/images/testimonial-15.jpg";
import TestimonialImg07 from "@/public/images/testimonial-16.jpg";
import TestimonialImg08 from "@/public/images/testimonial-17.jpg";
import TestimonialImg09 from "@/public/images/testimonial-18.jpg";
import ClientImg01 from "@/public/images/client-logo-10.svg";
import ClientImg02 from "@/public/images/client-logo-11.svg";
import ClientImg03 from "@/public/images/client-logo-12.svg";
import ClientImg04 from "@/public/images/client-logo-13.svg";
import ClientImg05 from "@/public/images/client-logo-14.svg";
import ClientImg06 from "@/public/images/client-logo-15.svg";
import ClientImg07 from "@/public/images/client-logo-07.svg";
import ClientImg08 from "@/public/images/client-logo-17.svg";
import ClientImg09 from "@/public/images/client-logo-18.svg";
...
const testimonials = [
  {
    ...
    name: "Bitcoin",
    company: "Satoshi Nakamoto",
    content:
    "The original store of value in crypto. We view Bitcoin as the digital gold and a foundational layer for macro exposure to the decentralized financial system.",
    categories: [1, 2,],
  },
  {
    ...
    company: "Gracy Chen",
    content:
    "A utility token tied to the rapidly growing Bitget ecosystem. Held for exchange-related benefits, trading advantages, and ecosystem incentives.",
    categories: [1, 3],
  },
  {
    ...
    company: "Jeff Yan ",
    content:
      "An emerging leader in decentralized perpetual trading. HYPE represents next-gen on-chain derivatives with unmatched speed and UX—our early thesis aligns with its protocol design and traction.",
    categories: [1, 2, 3],
  },
  {
    ...
    company: "Evan Cheng",
    content:
      "A high-performance Layer-1 chain focused on speed, object-centric programming, and mainstream usability. SUI is part of our exposure to scalable L1 solutions.",
    categories: [1, 2, ],
  },
  {
    ...
    name: "Solana",
    company: "Anatoly Yakovenko",
    content:
      "Ast, scalable, and efficient. Blockchains powering the next era of Web3 applications.",
    categories: [1, 2, ],
  },
  {
    ...
    company: "J.R. Willett",
    content:
      "We maintain USDT as a liquidity anchor and risk management tool, stable operations during market volatility.",
    categories: [1, 4, 5 ],
  },
  {
    ...
    name: "Binance",
    company: "Changpeng Zhao (CZ)",
    content:
      "Fueling the largest crypto exchange ecosystem, BNB plays a critical role in DeFi, trading, and infrastructure.",
    categories: [1, 2, 3],
  },
  {
    ...
    name: "AAVE",
    company: "Stani Kulechov",
    content:
      "Leading decentralized lending protocol. AAVE is key to the DeFi infrastructure layer, and we hold it for exposure to credit markets without intermediaries.",
    categories: [1, 4],
  },
  {
    ...
    name: "PAXG",
    company: "Charles Cascarilla",
    content:
      "A regulated digital asset backed by physical gold. PAXG allows exposure to the stability of gold while benefiting from blockchain liquidity and transparency.",
    categories: [1, 4],
  },
];
